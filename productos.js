...
switch (categoriaNum){
    ...
    return categoria
    break;
    case 1: categoria ="productos-nuevos";
    return categoria
    break;
    case 2: categoria ="nuestras-ofertas";
    return categoria
    break;
    case 3: categoria ="mas-vendido";
    return categoria
    break;
    case 4: categoria ="mas-buscado";
    return categoria
    break;
}
}
...
function mostrarElementosPorCategoriaYMarca(categoria = '', marca = '') {
  ...
  for (let i = 0; i < images.length; i++) {
    ...
    if ((categoria === '' || image.category === categoria) && (marca === '' || image.brand === marca)) {
      let imageElement = document.createElement("img");
      imageElement.src = image.src;
...
let botonMarcaInternational = document.getElementById("botonMarcaInternational");
